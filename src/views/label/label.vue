<template>
  <div class="slideTxtBox">
          ...
          <a class="prev" v-if="config.pnLoop.value" @click="changePic('pre')" href="javascript:void(0)"></a>
			...
			<div class="bd">
				<ul v-for="(v,k) in data" :key="k" v-show="k===activeIndex">
...
<style lang="less">
    ...
    body{ background:#fff; font-weight: normal;}
		...
		.slideTxtBox .hd ul li.on{ height:30px;  background:#fff; border:1px solid #ddd; border-bottom:2px solid #fff; font-weight: bold;}
